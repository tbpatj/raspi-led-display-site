...
const AddressableStripIcon: React.FC<BasicIcon> = ({
  width = "76",
  height = "16",
  stroke = "#ece5ec",
}) => {
  return (
    ...
    >
      <path d="M9 5H15V11H9V5Z" fill="#FF0054" />
      <path d="M22 5H28V11H22V5Z" fill="#EDFF86" />
      <path d="M35 5H41V11H35V5Z" fill="#7CEA9C" />
      <path d="M48 5H54V11H48V5Z" fill="#D65780" />
...
export default AddressableStripIcon;
